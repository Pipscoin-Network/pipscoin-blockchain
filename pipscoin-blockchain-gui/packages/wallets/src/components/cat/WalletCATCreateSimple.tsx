...
import { Back, Flex, Loading, useShowError } from '@pipscoin/core';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@pipscoin/api-react';
import WalletCreateCard from '../create/WalletCreateCard';
import isCATWalletPresent from '../../utils/isCATWalletPresent';
import type { CATToken } from '@pipscoin/api';
import useWalletState from '../../hooks/useWalletState';
import { SyncingStatus } from '@pipscoin/api';
