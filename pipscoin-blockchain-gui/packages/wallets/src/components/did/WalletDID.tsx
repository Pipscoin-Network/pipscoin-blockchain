...
import { AlertDialog, Card, Flex, Loading, Dropzone, mojoToPipscoinLocaleString } from '@pipscoin/core';
import {
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToPipscoinLocaleString(props.balance)} TPIPS
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'pipscoin_addr://') {
