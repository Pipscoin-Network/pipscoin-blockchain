...
If you want to learn more about this project, read the [wiki](https://github.com/Pipscoin-Network/pipscoin-blockchain/wiki), or check out the [green paper](https://www.pipscoinnetwork.org/assets/PipscoinGreenPaper.pdf).
...
We provide a [pre-commit configuration](https://github.com/Pipscoin-Network/pipscoin-blockchain/blob/main/.pre-commit-config.yaml) which triggers several useful
...
If you are not a Pipscoin organization member, you can enquire about deploying a `beta testnet` in the public dev Discord channel.
