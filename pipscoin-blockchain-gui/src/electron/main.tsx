    ...
    const template = [
      ...
      },
      {
        ...
        submenu: [
		  ...
		  {
            label: i18n._(/* i18n */ { id: 'Visit Pipscoin Website' }),
            click: () => {
              openExternal(
                'https://pipscoin.net',
              );
          ...
          },	
          {
            ...
            click: () => {
              openExternal(
                'https://www.facebook.com/PipscoinNetwork',
              );
            },
          },	
          {
          ...
          },	
          {
            ...
            click: () => {
              openExternal(
                'https://www.reddit.com/r/PipscoinNetwork',
              );
            },
          },
        ],
