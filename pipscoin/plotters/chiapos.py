"""
NOTE: This contains duplicate code from `pipscoin.cmds.plots`.
After `pipscoin plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
import pkg_resources
from pipscoin.plotting.create_plots import create_plots, resolve_plot_keys
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Pipscoin Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_pipscoin(args, root_path):
