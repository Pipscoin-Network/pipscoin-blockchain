...
import { Flex, UnitFormat, More, Table, mojoToPipscoinLocaleString, Suspender } from '@pipscoin/core';
...
import { WalletStatus } from '@pipscoin/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToPipscoinLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
