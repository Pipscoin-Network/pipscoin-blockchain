...
import { AlertDialog, Card, Flex, pipscoinToMojo, mojoToPipscoinLocaleString } from '@pipscoin/core';
import {
  send_transaction,
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  ...
                  {mojoToPipscoinLocaleString(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToPipscoinLocaleString(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const SendCard = (props) => {
  ...
  function send() {
    ...
    const amount = pipscoinToMojo(amount_input.value);
    const fee = pipscoinToMojo(fee_input.value);
