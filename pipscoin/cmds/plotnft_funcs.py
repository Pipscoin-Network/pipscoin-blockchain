...
from pipscoin.pools.pool_config import load_pool_config, PoolWalletConfig, update_pool_config
...
from pipscoin.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
...
async def create(args: dict, wallet_client: WalletRpcClient, fingerprint: int) -> None:
    ...
    fee_mojos = uint64(int(fee * units["pipscoin"]))
    ...
    if user_input.lower() == "y" or user_input.lower() == "yes":
        try:
            ...
            print(f"Error creating plot NFT: {e}\n    Please start both farmer and wallet with:  pipscoin start -r farmer")
        return
    print("Aborting.")
