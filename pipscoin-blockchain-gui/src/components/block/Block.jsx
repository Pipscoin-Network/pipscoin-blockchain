...
export default function Block() {
  ...
  const poolReward = byte_to_pipscoin(calculatePoolReward(blockRecord.height));
  const baseFarmerReward = byte_to_pipscoin(
    calculateBaseFarmerReward(blockRecord.height),
  );

  const pipscoinFees = blockRecord.fees
    ? byte_to_pipscoin(BigInt(blockRecord.fees))
    : '';
