...
import { CardStep, Select, StateColor } from '@pipscoin/core';
import { useGetPlottersQuery } from '@pipscoin/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@pipscoin/api';
import type { Plotter, PlotterMap } from '@pipscoin/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.PIPSCOINPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Pipscoin Proof of Space plotter. If unsure,
            use the default Pipscoin Proof of Space plotter.
        </Trans>
      </Typography>
