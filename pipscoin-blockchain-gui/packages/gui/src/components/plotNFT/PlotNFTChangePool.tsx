...
import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@pipscoin/api-react';
import { Flex, State, Loading, StateTypography } from '@pipscoin/core';
