...
# https://github.com/Pipscoin-Network/pipscoin-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `pipscoin version` to version property of GUI's package.json
