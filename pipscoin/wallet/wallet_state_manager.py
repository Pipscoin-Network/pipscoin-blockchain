...
from pipscoin.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from pipscoin.pools.pool_wallet import PoolWallet
from pipscoin.protocols import wallet_protocol
from pipscoin.protocols.wallet_protocol import PuzzleSolutionResponse, RespondPuzzleSolution, CoinState
...
from pipscoin.util.config import process_config_start_method
from pipscoin.util.db_wrapper import DBWrapper
from pipscoin.util.errors import Err
from pipscoin.util.ints import uint32, uint64, uint128, uint8
from pipscoin.util.db_synchronous import db_synchronous_on
from pipscoin.wallet.cat_wallet.cat_utils import match_cat_puzzle, construct_cat_puzzle
from pipscoin.wallet.cat_wallet.cat_wallet import CATWallet
from pipscoin.wallet.cat_wallet.cat_constants import DEFAULT_CATS
from pipscoin.wallet.derivation_record import DerivationRecord
from pipscoin.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from pipscoin.wallet.key_val_store import KeyValStore
from pipscoin.wallet.puzzles.cat_loader import CAT_MOD
...
from pipscoin.wallet.util.compute_hints import compute_coin_hints
from pipscoin.wallet.util.transaction_type import TransactionType
from pipscoin.wallet.util.wallet_sync_utils import last_change_height_cs
...
from pipscoin.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def fetch_parent_and_check_for_cat(
        self, peer: WSPipscoinConnection, coin_state: CoinState, fork_height: Optional[uint32]
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSPipscoinConnection, fork_height: Optional[uint32]
    ) -> None:
