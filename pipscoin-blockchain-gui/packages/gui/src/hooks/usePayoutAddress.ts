import type { PlotNFT } from '@pipscoin/api';
import { useSetPayoutInstructionsMutation, useGetNetworkInfoQuery } from '@pipscoin/api-react';
import { toBech32m, fromBech32m } from '@pipscoin/core';
