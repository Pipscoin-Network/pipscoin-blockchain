...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@pipscoin/api-react';
import { Wallet, WalletType } from '@pipscoin/api';
    ...
    if (!isLoading && tradeSide === 'sell' && walletBalance && walletBalance.walletId == row.assetWalletId) {
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToPipscoinLocaleString(walletBalance.spendableBalance);
          balance = mojoToPipscoin(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
