...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Pipscoin versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Pipscoin keyring")
@click.pass_context
