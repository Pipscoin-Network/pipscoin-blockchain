...
from pipscoin.protocols.protocol_timing import INVALID_PROTOCOL_BAN_SECONDS, API_EXCEPTION_BAN_SECONDS
...
from pipscoin.util.ssl import verify_ssl_certs_and_keys
    ...
    async def get_peer_info(self) -> Optional[PeerInfo]:
        ...
        try:
            ...
            async with ClientSession(timeout=timeout) as session:
                async with session.get("https://ip.pipscoin.net/") as resp:
                    if resp.status == 200:
