...
from pipscoin.ssl.create_ssl import (
    ensure_ssl_dirs,
    generate_ca_signed_cert,
    get_pipscoin_ca_crt_key,
    make_ca_cert,
...
def create_all_ssl(root_path: Path):
    ...
    write_ssl_cert_and_key(pipscoin_ca_crt_path, pipscoin_ca_crt, pipscoin_ca_key_path, pipscoin_ca_key)
