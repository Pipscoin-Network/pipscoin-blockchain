...
This library provides react hooks on the top of @pipscoin/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Pipscoin Blockchain).
...
import { useGetPublicKeysQuery } from '@pipscoin/api-react';
...
import { store, api } from '@pipscoin/api-react';
