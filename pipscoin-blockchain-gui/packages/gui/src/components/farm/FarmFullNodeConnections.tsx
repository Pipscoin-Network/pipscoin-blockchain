...
import { useGetFarmerFullNodeConnectionsQuery, useIsServiceRunningQuery } from '@pipscoin/api-react';
import type { Connection } from '@pipscoin/api';
import { ServiceName } from '@pipscoin/api';
