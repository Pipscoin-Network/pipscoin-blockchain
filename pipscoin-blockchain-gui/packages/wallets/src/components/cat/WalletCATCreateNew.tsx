...
import { pipscoinToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@pipscoin/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = pipscoinToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Pipscoin Asset Token Wallet</Trans>
        </Back>
        <Card>
