...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "38444"
            testnet_introducer = "testnet-introducer.pipscoin.net"
            testnet_dns_introducer = "dns-testnet-introducer.pipscoin.net"
            testnet = "testnet1"
            ...
            mainnet_port = "7477"
            mainnet_introducer = "introducer.pipscoin.net"
            mainnet_dns_introducer = "dns-introducer.pipscoin.net"
            net = "mainnet"
