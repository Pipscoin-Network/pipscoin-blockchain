...
import pipscoinToMojo from '../../utils/pipscoinToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isPipscoinCurrency = ['PIPS', 'TPIPS'].includes(currencyCode);
  const mojo = isPipscoinCurrency 
    ? pipscoinToMojo(correctedValue) 
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isPipscoinCurrency ? 12 : 3,
          },
          endAdornment: (
