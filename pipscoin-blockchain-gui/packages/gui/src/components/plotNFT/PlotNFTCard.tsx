...
import { Plot as PlotIcon } from '@pipscoin/icons';
import { useDeleteUnconfirmedTransactionsMutation } from '@pipscoin/api-react';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: (
        <UnitFormat
          value={mojoToPipscoinLocaleString(balance)}
          state={State.SUCCESS}
        />
      ),
    },
