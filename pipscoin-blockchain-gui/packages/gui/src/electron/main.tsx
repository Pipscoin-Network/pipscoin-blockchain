...
import AppIcon from '../assets/img/pipscoin64x64.png';
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Pipscoin-Network/pipscoin-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://twitter.com/PipscoinNetwork');
            },
          },
        ],
      },
