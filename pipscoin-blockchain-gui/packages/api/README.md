...
This library provides support for TypeScript/JavaScript [Pipscoin](https://www.pipscoinnetwork.org) apps to access the [Pipscoin Blockchain RPC](https://github.com/Pipscoin-Network/pipscoin-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Pipscoin Blockchain RPC.
...
```ts
import Client, { Wallet } from '@pipscoin/api';
