...
import { Dropdown, Flex, Loading, useTrans } from '@pipscoin/core';
import { useGetWalletsQuery } from '@pipscoin/api-react';
import { WalletType, type Wallet } from '@pipscoin/api';
